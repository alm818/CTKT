...
public class BuyView extends PostView{
	private static final String[] COLUMN_TITLE = { "Mã mặt hàng", "Tên mặt hàng", "Mua không KM", "Mua KM", "Tổng bán", "Thành tiền", "Đơn giá"};
	...
	public BuyView(String title, String name, Object... objects) {
	...
	protected void getParameters(Object... objects) throws SQLException {
		...
		Bill bill = BillDAO.getBill(codeBuy);
