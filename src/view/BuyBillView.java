...
public class BuyBillView extends PostView{
	private static final String[] COLUMN_TITLE = { "Ngày hóa đơn", "Mã hóa đơn", "Mã nhà cung cấp", "Tên nhà cung cấp", "Mua không KM", "Mua KM", "Thành tiền", "Đơn giá"};
	...
	public BuyBillView(String title, String name, Object... objects) {
	...
	protected void getParameters(Object... objects) throws SQLException {
		...
		ArrayList<Bill> billList = BuyDAO.getDiary(nameProduct, from, to);
