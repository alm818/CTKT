...
public class SellBillView extends PostView{
	private static final String[] COLUMN_TITLE = { "Ngày hóa đơn", "Mã hóa đơn", "Mã khách hàng", "Tên khách hàng", "Bán không KM", "Bán KM", "Thành tiền", "Đơn giá"};
	...
	public SellBillView(String title, String name, Object... objects) {
	...
	protected void getParameters(Object... objects) throws SQLException {
		...
		ArrayList<Bill> billList = SellDAO.getDiary(nameProduct, from, to);
