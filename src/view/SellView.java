...
public class SellView extends PostView{
	private static final String[] COLUMN_TITLE = { "Mã mặt hàng", "Tên mặt hàng", "Bán không KM", "Bán KM", "Tổng bán", "Thành tiền", "Đơn giá"};
	...
	public SellView(String title, String name, Object... objects) {
